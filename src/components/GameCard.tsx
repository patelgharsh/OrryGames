...
export default function GameCard({ title, category, thumb, onClick }: GameCardProps) {
  const colors = [
  ...
  return (
    ...
    >
      <div className={`h-40 ${thumb ? 'bg-gray-100 dark:bg-gray-800' : `bg-gradient-to-br ${gradient}`} flex items-center justify-center relative overflow-hidden`}>
        {thumb ? (
          <img
            src={thumb}
            alt={title}
